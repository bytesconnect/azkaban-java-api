package com.bytesconnect.azkaban.api;

import com.bytesconnect.azkaban.response.*;
...
public class AzkabanApiImpl implements AzkabanApi {
    ...
    @Override
    public ExecuteFlowResponse executeFlow(String projectName, String flowName, List<NameValuePair> paramList) {
        Request res = Request.Post(MessageFormat.format(EXECUTE_FLOW, uri, sessionId, projectName, flowName));
        if(paramList != null && !paramList.isEmpty()){
            res = res.bodyForm(paramList, StandardCharsets.UTF_8);
        }
